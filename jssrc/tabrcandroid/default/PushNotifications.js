...
function onlinePushNotificationCallback(pushMsg) {
    ...
    if (kony.os.deviceInfo().name === "android") {
        basicConfig = {
            message: pushMsg.content,
            alertType: constants.ALERT_TYPE_INFO,
            alertTitle: pushMsg.title,
            yesLabel: "OK",
            alertHandler: null,
            alertIcon: "ohiolmi_icon.png"
        };
    } else {
        basicConfig = {
            message: pushMsg.alert.body,
            alertType: constants.ALERT_TYPE_INFO,
            alertTitle: pushMsg.alert.title,
            yesLabel: "OK",
            alertHandler: null
        };
    }
